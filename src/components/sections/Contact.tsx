                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-5">
                                ...
                                <div>
                                    <h3 className="text-slate-100 font-bold mb-1">WhatsApp</h3>
                                    <a href={`https://wa.me/${contactData.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-brand transition-colors">
                                        {contactData.phone}
                                    </a>
                                </div>
                            </div>
